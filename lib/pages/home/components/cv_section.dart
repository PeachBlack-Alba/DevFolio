// import 'package:dev_folio/models/design_process.dart';
...
//       child: ScreenHelper(
//         desktop: _buildUi(context, DesktopMaxWidth),
//         tablet: _buildUi(context, TabletMaxWidth),
...
//                     childAspectRatio:
//                         ScreenHelper.isDesktop(context) ? 1 : MediaQuery.of(context).size.aspectRatio * 1.5,
//                   ),
